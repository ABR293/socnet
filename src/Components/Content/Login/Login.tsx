...
const LoginForm:React.FC<InjectedFormProps<LoginFormValuesType> & LoginFormOwnPropsType> = ({error, handleSubmit, captchaURL}) => {
    ...
    return(
        <form onSubmit={handleSubmit}>
            <div className={style.input}>
                ...
                { createField<LoginFormValuesTypeKeys>('password', 'password',[required, maxlength20, minlength4], Input )}
                { createField<LoginFormValuesTypeKeys>('', 'rememberMe',[required, maxlength20, minlength4], Checkbox )}
